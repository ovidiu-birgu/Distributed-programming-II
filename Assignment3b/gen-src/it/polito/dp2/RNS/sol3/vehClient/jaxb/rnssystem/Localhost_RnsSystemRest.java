...
}, comments = "wadl2java, http://wadl.java.net", date = "2019-01-20T18:00:07.371+01:00")
public class Localhost_RnsSystemRest {
    ...
    public static class Connections {
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Connections getAsConnectionsXml() {
            ...
            return response.getEntity(it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Connections.class);
        }
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Connections getAsConnectionsXml(Long page) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (page == null) {
            }
            if (page!= null) {
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Connections getAsConnectionsJson() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Connections getAsConnectionsJson(Long page) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (page == null) {
            }
            if (page!= null) {
    ...
    public static class Places {
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Places getAsPlacesXml() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/xml");
            ...
            return response.getEntity(it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Places.class);
        }
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Places getAsPlacesXml(Long page, String type) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (page == null) {
            }
            if (page!= null) {
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Places getAsPlacesJson() {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
            resourceBuilder = resourceBuilder.accept("application/json");
        ...
        public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Places getAsPlacesJson(Long page, String type) {
            UriBuilder localUriBuilder = _uriBuilder.clone();
            if (page == null) {
            }
            if (page!= null) {
        ...
        public static class IdVehicles {
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesXml() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles.class);
            }
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesXml(Long page) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                if (page == null) {
                }
                if (page!= null) {
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesJson() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/json");
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesJson(Long page) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                if (page == null) {
                }
                if (page!= null) {
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesTextHtml() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("text/html");
            ...
            public it.polito.dp2.RNS.sol3.vehClient.jaxb.rnssystem.Vehicles getAsVehiclesTextHtml(Long page) {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                if (page == null) {
                }
                if (page!= null) {
