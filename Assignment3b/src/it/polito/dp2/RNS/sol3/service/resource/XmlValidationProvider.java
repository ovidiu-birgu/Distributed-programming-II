...
public class XmlValidationProvider<T> implements MessageBodyReader<T> {
	private final String JAXB_PACKAGE = "it.polito.dp2.RNS.sol3.service.jaxb.rnssystem";
	private final String SCHEMA_FILE = "/xsd/RnsSystem.xsd";
	...
	public XmlValidationProvider() {
		...
		try {				
			InputStream schemaStream = XmlValidationProvider.class.getResourceAsStream(SCHEMA_FILE);
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return JAXB_PACKAGE.equals(type.getPackage().getName());
	}
